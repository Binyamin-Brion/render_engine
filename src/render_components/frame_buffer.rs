...
impl FBO
{
               ...
               stencil_attachment: Option<TextureInformation>, depth_stencil_attachment: Option<TextureInformation>) -> Result<FBO, String>
    {
        ...
        {
            FBO::setup_attachment_internal(stencil_attachment, AttachmentFormat::DepthAndStencilAttachment,  None, fbo, &mut stencil_texture);
        }

        if let Some(depth_stencil_attachment) = depth_stencil_attachment
        {
            FBO::setup_attachment_internal(depth_stencil_attachment, AttachmentFormat::StencilAttachment, None, fbo, &mut depth_stencil_texture);
        }
