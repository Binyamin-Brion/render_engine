...
use crate::render_system::system_information::{Constant, DrawFunction, FragmentShaderInformation,
                                               GLSLVersion, SystemInformation, VertexShaderInformation};
...
{
    pub fn with_draw_function(mut self, draw_fn: DrawFunction) -> LevelOfViewsBuilder
    {
...
{
    pub fn with_light_constraints(mut self, constraints: MaxLightConstraints) -> CreateRenderSystemBuilder
    {
