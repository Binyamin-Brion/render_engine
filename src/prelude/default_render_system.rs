...
pub fn create_default_render_system(draw_function: DrawFunction,
                                    ...
                                    max_lights: MaxNumLights) -> RenderSystem
{
    ...
    let mut render_system = RenderSystemBuilder::new()
        ...
        .with_vertex_shader(VertexShaderInformation
        {
            ...
            layout_info: vec!
            [
                LayoutInformation::new(LayoutType::Vec3Float, LayoutInstance::Divisor0(1, 150000), LayoutUse::PerModel, "aPos"),
                LayoutInformation::new(LayoutType::Vec4Float, LayoutInstance::Divisor0(1, 200000), LayoutUse::PerModel, "texCoords"),
                LayoutInformation::new(LayoutType::Vec4Uint, LayoutInstance::Divisor0(1, 150000), LayoutUse::PerModel, "layers"),
                LayoutInformation::new(LayoutType::Vec3Float, LayoutInstance::Divisor0(1, 150000), LayoutUse::PerModel, "normal"),
                LayoutInformation::new(LayoutType::Mat4x4Float, LayoutInstance::Divisor1(1, 152400), LayoutUse::PerInstance, "translation"),
            ],
            out_variables: vec!
            [
        ...
        .with_second_pass_fragment_shader(FragmentShaderInformation
        {
            ...
            [
                ...
                [
                    ...
                    Uniform::new("directionLightDir", UniformType::Vec3Array(max_lights.directional)),
                    ...
                    Uniform::new("spotLightPositions", UniformType::Vec3Array(max_lights.spot)),
                    ...
                    Uniform::new("pointLightPositions", UniformType::Vec3Array(max_lights.point)),
                    Uniform::new("pointLightDirections", UniformType::Vec3Array(max_lights.point)),
        ...
        .with_draw_function(draw_function)
