...
pub struct AddModelArgs
{
    ...
    pub requesting_entity: EntityId,
    pub model_name: String,
    pub geometry: Vec<ModelGeometry>, // One model for each Level of View Provided
    pub lov: Option<Vec<LevelOfView>>,
    pub change_requests: Vec<EntityChangeRequest>,
    // TODO: Add opportunity to render texture from FBO
}
